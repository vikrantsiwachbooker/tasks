...
define('dummy/routes/fb-login', ['exports', 'ember'], function (exports, _ember) {
...
define("dummy/templates/fb-login", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        "fragmentReason": {
        ...
        "moduleName": "dummy/templates/fb-login.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el1, "class", "fb-login-button");
        dom.setAttribute(el1, "data-max-rows", "1");
        dom.setAttribute(el1, "data-size", "xlarge");
        dom.setAttribute(el1, "data-show-faces", "false");
        dom.setAttribute(el1, "data-auto-logout-link", "false");
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
        dom.appendChild(el0, el1);
        return el0;
...
if (!runningTests) {
  require("dummy/app")["default"].create({"name":"ember-cli-facebook-js-sdk","version":"1.0.7+29bedb81"});
}
